...
//--- UNCOMMENT THESE WHEN COPYING TO YOUR LOCAL PROJECT ---
...
// // --- CANVAS PREVIEW MOCKS (REMOVE THESE LOCALLY) ---
...
const SocialIcons = () => {
  useEffect(() => {
    ...
    if (!social) return; // Adding this prevents app crashes if element isn't found
  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/Abhiimaurya0080" target="_blank">
            <FaGithub />
          </a>
        </span>
        <span>
          <a href="https://www.linkedin.com/in/abhishek-maurya-53185232a/" target="_blank">
            <FaLinkedinIn />
          </a>
        </span>
        <span>
        ...
        <span>
          <a href="https://www.instagram.com/__abhii_maurya__04?igsh=Mm5uOGdkOG5kbTZs" target="_blank">
            <FaInstagram />
          </a>
        </span>
      </div>
      <a className="resume-button" href="/abhishek_maurya_resume.pdf" target="_blank">
