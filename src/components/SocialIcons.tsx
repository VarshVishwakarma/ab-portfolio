...
// Local fallbacks for unresolvable react-icons to ensure the build succeeds
...
const SocialIcons = () => {
  ...
  useEffect(() => {
    ...
    social.querySelectorAll("span.icon-wrapper").forEach((item) => {
      ...
      const updatePosition = () => {
        ...
        // Centering offset calculations for the moving anchor inside the span
  ...
  return (
    <div className="icons-section">
      <style>{`
        ...
        .icon-wrapper a {
          position: absolute;
          /* Uses the JS injected variables for the hover physics */
          ...
          pointer-events: none; /* Let the wrapper handle the mouse events perfectly */
        }
