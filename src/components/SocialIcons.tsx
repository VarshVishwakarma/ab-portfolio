...
// Mocking imports so the code compiles in this preview environment
...
/* When copying to your local project, please replace the mocked functions above 
  with your original imports:
  ...
  return (
    <div className="icons-section">
      ...
      <div className="social-icons" data-cursor="icons" id="social">
        ...
        <span>
          <a
            href="https://www.instagram.com/__abhii_maurya__04?igsh=Mm5uOGdkOG5kbTZs"
            target="_blank"
          >
            <FaInstagram />
          </a>
